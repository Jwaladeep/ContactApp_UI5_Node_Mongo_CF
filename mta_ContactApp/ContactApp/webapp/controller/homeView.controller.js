sap.ui.define([
	...
	return Controller.extend("com.sap.ContactApp.ContactApp.controller.homeView", {
		...
		refreshTable: function (oEvent) {
			...
			//updating the model
			$.ajax({
				url: "https://contactapp-unadjourned-subchapter.cfapps.eu10.hana.ondemand.com/contactApp",
				method: "GET",
				async: false,
				crossDomain: true,
		...
		onSaveAdd: function (oEvent) {
			...
			//	d = JSON.stringify(d);
			$.ajax({
				url: "https://contactapp-unadjourned-subchapter.cfapps.eu10.hana.ondemand.com/contactApp/create",
...
/*			d = JSON.stringify(d);*/
			$.ajax({
				url: "https://contactapp-unadjourned-subchapter.cfapps.eu10.hana.ondemand.com/contactApp/update",
				data: d,
				method: "PUT",
				crossDomain: true,
				async: false,
		...
		onDelete: function (data) {
			...
			$.ajax({
				url: "https://contactapp-unadjourned-subchapter.cfapps.eu10.hana.ondemand.com/contactApp/delete",
				data: d,
				method: "DELETE",
				crossDomain: true,
				async: false,
